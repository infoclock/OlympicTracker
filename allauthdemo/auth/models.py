...
class DemoUser(AbstractBaseUser, PermissionsMixin):
    ...
    is_participating_2016 = models.BooleanField(_('Partcipating 2015-2016 2nd semester'), default=False,
                                                help_text=_('Bifeaza aici daca esti anul 1 si vrei sa echivalezi semestrul 2'))
